                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="footer-item d-flex flex-column">
                                ...
                                <Link to="/travel-blog"><i className="fas fa-angle-right me-2"></i> Blog</Link>
                                <a href=""><i className="fas fa-angle-right me-2"></i> Press</a>
                                <a href=""><i className="fas fa-angle-right me-2"></i> Gift Cards</a>
                                <Link to="/travel-gallery"><i className="fas fa-angle-right me-2"></i> Gallery</Link>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="footer-item d-flex flex-column">
                ...
                <div className="container">
                    <div className="row g-4 align-items-center">
                        <div className="col-md-6 text-center text-md-end mb-md-0">
                            <i className="fas fa-copyright me-2"></i><a className="text-white" href="#">Your Site Name</a>, All right
                            reserved.
                        </div>
                        <div className="col-md-6 text-center text-md-start">

                            Designed By <a className="text-white" href="">HTML Temple</a> Distributed By <a
                                href="">Temple</a>
                        </div>
                    </div>
                </div>
