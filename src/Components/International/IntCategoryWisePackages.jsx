...
import Header2 from '../Common/Header2';
import Footer from '../Common/Footer';
import { countries, categoryContent } from '../js/internationalCityData';  // Import data from internationalData.js
            ...
            <div className="container">
                ...
                <div className="row">
                    {countries.map((country) => (
                        <div key={country.name} className="col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div className={styles.countryCard}>
                                <Link to={`/packages/international/${country.name.toLowerCase()}`}>
                                    <img
                                        src={country.image}
                                        alt={`${country.name} landscape`}
                                        className={styles.countryImage}
